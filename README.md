...
- [X] Авторизация
- [X] Диалоговое окно об ошибке
- [ ] Тестирование авторизации на клиенте, unit test
- [X] Отрисовка экрана добавления задачи
...
- [X] Добавление команды по коду на клиенте
...
<!-- functional-requirements / Requirements analysis app mobile  -->
